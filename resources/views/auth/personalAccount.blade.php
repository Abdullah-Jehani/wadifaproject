            ...
            <div class="container flex-col  bg-white rounded-3xl my-12 pr-8 py-4">
                ...
                <div class="container flex  bg-white rounded-3xl py-12 pr-24">
                    <div class="flex flex-col items-end space-y-4 w-[80%]">
                        ...
                        <input class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px]" value="{{ old('titlename') }}" type="text" name="titlename" id="titlename" placeholder="دو" dir="rtl" style="outline:none">
                        @error('titlename')
                        <h1 class="text-danger">{{ $message }}</h1>
                        @enderror

                        <label for="field2" class="block text-gray-700 text-sm font-bold mb-2">العنوان</label>
                        <input class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px]" value="{{ old('location') }}" type="text" name="location" id="location" placeholder="بنغازي" dir="rtl" style="outline:none">
                        @error('location')
                        <h1 class="text-danger">{{ $message }}</h1>
                        ...
                        <input class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px]" value="{{ old('phone_number') }}" type="text" name="phone_number" id="phone_number" dir="rtl" placeholder="09XXXXXXXX" style="outline:none">
                        @error('phone_number')
                        <h1 class="text-danger">{{ $message }}</h1>
                    ...
                    <div class="flex flex-col items-end space-y-4 w-3/4 mr-12">
                        ...
                        <input class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px]" value="{{ old('username') }}" type="text" name="username" id="username" placeholder="جون" dir="rtl" style="outline:none">
                        @error('username')
                        <h1 class="text-danger">{{ $message }}</h1>
                        @enderror
                        ...
                        <select class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px] font-bold" name="education" id="education" dir="rtl" style="color: #6B7980; outline: none;">
                            <option value="" disabled selected>اختر من القائمة</option>
                            <option class="font-bold" value="بكالوريوس">بكالوريوس</option>
                            <option class="font-bold" value="ماجستير">ماجستير</option>
                            <option class="font-bold" value="طالب جامعي">طالب جامعي</option>
                        </select>
                        ...
                        <input class="bg-inputfield rounded-md px-3 py-2 w-[80%] h-[60px]" type="text" name="jobtitle" id="jobtitle" placeholder="مطور واجهات امامية" dir="rtl" style="outline:none" value="{{ old('jobtitle') }}">
